...
Everything in Sections~\ref{sec:results1}--\ref{sec:zeroday} uses the custom 5-bus microgrid. We tested the topology-fusion finding at a larger, standard scale, escalating sample size across three passes until matched to Section~\ref{sec:results1}'s own statistical power.
...
\begin{table}[t]
\centering
\caption{5-bus vs.\ IEEE 14-bus: best result per task, at matched $n{=}300$-test-scenario power on both sides}
\label{tab:scale}
