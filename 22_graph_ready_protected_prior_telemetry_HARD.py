...
def plot_target_vs_nontarget(node_df):
    ...
    fig.tight_layout()
    fig.savefig(
        FIGURES / "48_graph_prior_innovation_target_vs_nontarget_hard.png",
        dpi=220,
    )
    plt.close(fig)
...
def plot_localization(diag):
    ...
    fig.tight_layout()
    fig.savefig(
        FIGURES / "49_residual_vs_prior_localization_hard.png",
        dpi=220,
    )
    plt.close(fig)
...
def plot_stealth_relation(node_df):
    ...
    fig.tight_layout()
    fig.savefig(
        FIGURES / "50_stealth_topology_footprint_hard.png",
        dpi=220,
    )
    plt.close(fig)
...
def main():
    ...
    node_df.to_csv(
        DATA / "phase2r_hard_graph_node_features.csv",
        index=False,
    )
    edge_df.to_csv(
        DATA / "phase2r_hard_graph_edge_features.csv",
        index=False,
    )
    graph_df.to_csv(
        DATA / "phase2r_hard_graph_metadata.csv",
        index=False,
    )
    summary.to_csv(
        RESULTS / "phase2r_hard_graph_telemetry_summary.csv",
        index=False,
    )
    diag.to_csv(
        RESULTS / "phase2r_hard_localization_diagnostic.csv",
        index=False,
    )
    ...
    print("\nSaved:")
    print("  data/phase2r_hard_graph_node_features.csv")
    print("  data/phase2r_hard_graph_edge_features.csv")
    print("  data/phase2r_hard_graph_metadata.csv")
    print("  results/phase2r_hard_graph_telemetry_summary.csv")
    print("  results/phase2r_hard_localization_diagnostic.csv")
    print("  figures/48_graph_prior_innovation_target_vs_nontarget_hard.png")
    print("  figures/49_residual_vs_prior_localization_hard.png")
    print("  figures/50_stealth_topology_footprint_hard.png")
