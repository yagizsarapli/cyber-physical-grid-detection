...
NODE_PATH = DATA / "phase2r_harder_graph_node_features.csv"
EDGE_PATH = DATA / "phase2r_harder_graph_edge_features.csv"
META_PATH = DATA / "phase2r_harder_graph_metadata.csv"
...
def plot_detection(metrics):
    ...
    fig.tight_layout()
    fig.savefig(
        FIGURES / "51_topology_detection_tradeoff_harder.png",
        dpi=220,
    )
    plt.close(fig)
...
def plot_localization(metrics):
    ...
    fig.tight_layout()
    fig.savefig(
        FIGURES / "52_topology_localization_top1_harder.png",
        dpi=220,
    )
    plt.close(fig)
...
def plot_score_map(graph_df):
    ...
    fig.tight_layout()
    fig.savefig(
        FIGURES / "53_residual_vs_prior_graph_map_harder.png",
        dpi=220,
    )
    plt.close(fig)
...
def save_rf_importance(graph_df, feat_sets):
    ...
    out.to_csv(
        RESULTS / "phase2s_harder_topology_rf_feature_importance.csv",
        index=False,
    )
    ...
    fig.tight_layout()
    fig.savefig(
        FIGURES / "54_topology_fusion_feature_importance_harder.png",
        dpi=220,
    )
    plt.close(fig)
...
def main():
    ...
    # ========================================================
    graph_df.to_csv(
        DATA / "phase2s_harder_graph_feature_matrix.csv",
        index=False,
    )

    node_learn.to_csv(
        DATA / "phase2s_harder_node_relational_feature_matrix.csv",
        index=False,
    )

    detection_df.to_csv(
        RESULTS / "phase2s_harder_cyber_detection_metrics.csv",
        index=False,
    )

    localization_df.to_csv(
        RESULTS / "phase2s_harder_attack_localization_metrics.csv",
        index=False,
    )
    ...
    print("\nSaved:")
    print("  data/phase2s_harder_graph_feature_matrix.csv")
    print("  data/phase2s_harder_node_relational_feature_matrix.csv")
    print("  results/phase2s_harder_cyber_detection_metrics.csv")
    print("  results/phase2s_harder_attack_localization_metrics.csv")
    print("  results/phase2s_harder_topology_rf_feature_importance.csv")
    print("  figures/51_topology_detection_tradeoff_harder.png")
    print("  figures/52_topology_localization_top1_harder.png")
    print("  figures/53_residual_vs_prior_graph_map_harder.png")
    print("  figures/54_topology_fusion_feature_importance_harder.png")
