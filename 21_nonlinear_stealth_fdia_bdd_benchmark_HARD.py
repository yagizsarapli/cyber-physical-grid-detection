...
# ============================================================
# PHASE 2Q -- HARD VARIANT
# NONLINEAR MODEL-CONSISTENT FDIA vs WLS / CHI-SQUARE BDD
# ============================================================
#
# Stress-test variant of 21_nonlinear_stealth_fdia_bdd_benchmark.py,
# built to answer Phase 2S's own caveat that its near-perfect result
# is not a final claim because these attacks have large state bias.
#
# Only change: attack magnitude reduced ~3x toward the noise floor.
#   naive magnitude   : U(0.035, 0.060) -> U(0.012, 0.025)
#   stealth dv        : U(0.012, 0.035) -> U(0.004, 0.012)
#   stealth da (deg)  : U(0.40, 2.20)   -> U(0.10, 0.50)
# Everything else (topology, WLS, noise, splits) is unchanged so this
# is a single-variable ablation against the original.
#
