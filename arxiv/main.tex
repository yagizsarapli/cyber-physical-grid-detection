...
\begin{table}[t]
\centering
\caption{IEEE 14-bus, \texttt{topology\_fusion} vs.\ \texttt{residual\_plus\_prior} (the strongest non-relational baseline in every seed), 4 independent seeds (500 repl.\ each)}
...
\begin{table}[t]
\centering
\caption{IEEE 30-bus, \texttt{topology\_fusion} vs.\ \texttt{residual\_plus\_prior} (the strongest non-relational baseline in every seed), 4 independent seeds (500 repl.\ each)}
